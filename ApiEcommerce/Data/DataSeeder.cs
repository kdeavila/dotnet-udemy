...
public static class DataSeeder
{
   public static void SeedData(ApplicationDbContext appContext)
   {
      ...
      if (!appContext.ApplicationUsers.Any())
      {
         ...
         // Seed de el usuario administrador
      ...
      if (!appContext.Products.Any())
      {
         appContext.Products.AddRange(
            new Product
            {
               ...
               ImageUrl = "https://placehold.co/300x300/FF0000/FFFFFF?text=Camiseta",
            ...
            new Product
            {
               ...
               ImageUrl = "https://placehold.co/300x300/0000FF/FFFFFF?text=Smartphone",
               CreationDate = DateTime.Now
            },
            new Product
            {
               ...
               ImageUrl = "https://placehold.co/300x300/00FF00/FFFFFF?text=Pelota",
               CreationDate = DateTime.Now
            },
            new Product
            {
               ...
               ImageUrl = "https://placehold.co/300x300/FFFF00/000000?text=Lampara",
               CreationDate = DateTime.Now
            },
            new Product
            {
               ...
               ImageUrl = "https://placehold.co/300x300/800080/FFFFFF?text=Libro",
               CreationDate = DateTime.Now
            },
            new Product
            {
               ...
               CategoryId = 1,
               Category = appContext.Categories.Find(1)!,
               ImageUrl = "https://placehold.co/300x300/4169E1/FFFFFF?text=Jeans",
               CreationDate = DateTime.Now
            },
            new Product
            {
               ...
               CategoryId = 2,
               Category = appContext.Categories.Find(2)!,
               ImageUrl = "https://placehold.co/300x300/C0C0C0/000000?text=Tablet",
               CreationDate = DateTime.Now
            },
            new Product
            {
               ...
               CategoryId = 3,
               Category = appContext.Categories.Find(3)!,
               ImageUrl = "https://placehold.co/300x300/000000/FFFFFF?text=Zapatillas",
               CreationDate = DateTime.Now
            },
            new Product
            {
               ...
               CategoryId = 4,
               Category = appContext.Categories.Find(4)!,
               ImageUrl = "https://placehold.co/300x300/2F4F4F/FFFFFF?text=Cafetera",
               CreationDate = DateTime.Now
            },
            new Product
            {
               ...
               CategoryId = 5,
               Category = appContext.Categories.Find(5)!,
               ImageUrl = "https://placehold.co/300x300/008B8B/FFFFFF?text=C%23+Book",
               CreationDate = DateTime.Now
            },
            new Product
            {
               ...
               CategoryId = 1,
               Category = appContext.Categories.Find(1)!,
               ImageUrl = "https://placehold.co/300x300/000080/FFFFFF?text=Chaqueta",
               CreationDate = DateTime.Now
            },
            new Product
            {
               ...
               CategoryId = 2,
               Category = appContext.Categories.Find(2)!,
               ImageUrl = "https://placehold.co/300x300/1C1C1C/FFFFFF?text=Auriculares",
               CreationDate = DateTime.Now
            }
         );
      }
